...
public class UsuarioController {
	...
	@GetMapping
	public ResponseEntity<List<Usuario>> listarUsuarios(){  //response entity 
	...
	@PostMapping
	public ResponseEntity<Usuario> guardarUsuario(@RequestBody Usuario usuario){//request boy se usa en post, para guardar datos o login
	...
	@CircuitBreaker(name = "motosCB" , fallbackMethod = "fallBackSavetMotos")
